...
# Project root folder which contains `VENV` and `src`.
PROJ_DIR = os.path.dirname(os.path.dirname(
    os.path.dirname(os.path.dirname(os.path.abspath(__file__)))))

# PROJ_DIR/src, where all Django code and manage.py live.
# Build paths inside the project like this: os.path.join(BASE_DIR, ...)
BASE_DIR = os.path.join(PROJ_DIR, 'src')

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'Put your own secret key at local_settings.py'
...
TEMPLATES = [
    {
        ...
        'DIRS': [JS_TEMPLATES, os.path.join(BASE_DIR, "templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_ROOT = os.path.join(PROJ_DIR, "static_cdn")

MEDIA_URL = '/media/'

MEDIA_ROOT = os.path.join(PROJ_DIR, "media_cdn")
